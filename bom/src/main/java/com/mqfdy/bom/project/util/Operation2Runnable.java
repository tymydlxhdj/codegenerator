...
public abstract class Operation2Runnable implements IRunnableWithProgress {
	...
	/**
	 * This method is here so that GradleRunnable can be used as an
	 * {@link IRunnableWithProgress}. It is final as you are not supposed to
	 * implement it directly. Implement the doit method instead.
	 *
	 * @author mqfdy
	 * @param monitor
	 *            the monitor
