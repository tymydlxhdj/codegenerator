...
import com.mqfdy.code.springboot.dbs.ConnectionListener;
	...
	implements ConnectionProfile, ConnectionProfileHolder
{
	...
	private String getDefaultSchemaName() {
		...
		if (this.getDatabase().getVendor().equalsIgnoreCase(KINGBASE_VENDOR)) {
			return KINGBASE_DEFAULT_SCHEMA_NAME;
		}
	...
	private class LocalConnectionListener implements IManagedConnectionOfflineListener {
		private Vector<ConnectionListener> innerListeners = new Vector<ConnectionListener>();
		...
		private Iterator<ConnectionListener> listeners() {
			return new CloneIterator<ConnectionListener>(this.innerListeners);
		}
