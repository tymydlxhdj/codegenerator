...
public class Logger {
	...
	public static IStatus createStatus(int severity, int code, String message,
			Throwable exception) {
		return new Status(severity, TemplatePlugin.PLUGIN_ID, code,
				message, exception);
	}
	...
	public static MultiStatus createMultiStatus(int severity, int code,
		...
		return new MultiStatus(TemplatePlugin.PLUGIN_ID, code,
				message, exception);
	}
	...
	public static void log(IStatus status) {
		TemplatePlugin.getDefault().getLog().log(status);
	}
	...
	public static void log(String message) {
		log(new Status(IStatus.ERROR, TemplatePlugin.PLUGIN_ID,
