...
/**
 * Interface describing the application data context. This set of routines is
 * used by the application to set and remove 'named' data object to pass them to
 * the template engine to use when rendering a template.
 * 
 * This is the same set of methods supported by the original Context class
 *
