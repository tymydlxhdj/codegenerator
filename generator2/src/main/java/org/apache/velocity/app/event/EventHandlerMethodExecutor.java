...
public interface EventHandlerMethodExecutor
{
    ...
    /**
	 * Execute the event handler method. If Object is not null, do not iterate
	 * further through the handler chain. If appropriate, the returned Object
    ...
    /**
	 * Called after execute() to see if iterating should stop. Should always
	 * return false before method execute() is run.
	 *
	 * @author mqfdy
