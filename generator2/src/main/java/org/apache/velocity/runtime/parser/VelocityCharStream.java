...
/**
 * NOTE : This class was originally an ASCII_CharStream autogenerated by Javacc.
 * It was then modified via changing class name with appropriate fixes for
 * CTORS, and mods to readChar().
 * 
 * This is safe because we *always* use Reader with this class, and never a
 * InputStream. This guarantees that we have a correct stream of 16-bit chars -
 * all encoding transformations have been done elsewhere, so we believe that
 * there is no risk in doing this. Time will tell :)
 *
 * @author mqfdy
 */
...
implements CharStream
{
    ...
    /**
	 * Instantiates a new velocity char stream.
	 *
	 * @param dstream
	 *            the dstream
	 * @param startline
