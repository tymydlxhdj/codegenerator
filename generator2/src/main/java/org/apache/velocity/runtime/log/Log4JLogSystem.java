...
/**
 * Implementation of a simple log4j system that will either latch onto an
 * existing category, or just do a simple rolling file log.
 * 
 * Use this one rather than {@link SimpleLog4JLogSystem}; it uses the modern
 * <code>Logger</code> concept of Log4J, rather than the deprecated
 * <code>Categeory</code> concept.
 *
